...
var my_accomodation = '<div class="my_accomodation testamonial col-9 mt-3 p-2">'
    ...
    + '<div class="col-2 col-xl-8 search_page_price">'
    + '<i class="fas fa-home"></i>'
    + '</div>'
    + '<div class="col-2 col-xl-8 search_page_price" style=" border-bottom: black solid 1px; text-align: center;">'
    ...
    + '</div>'
    + '</div>'
    + '<div class="col-2 col-xl-12 search_page_price mt-3" >'
...
var my_accomodation_booked = '<div class="my_accomodation testamonial col-9 mt-3 p-2">'
    + '<div class="row">'
    + '<div class="col-12 col-xl-5">'
    + '<img src="{{image}}">'
    + '</div>'
